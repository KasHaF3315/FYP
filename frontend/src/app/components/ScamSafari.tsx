...
function LevelView({
  ...
  return (
    <div className="max-w-3xl mx-auto relative z-10 pb-32">
      <button onClick={onBack} className="text-blue-100 hover:text-white p-2 relative z-20">
        <ArrowLeft className="w-6 h-6" />
      </button>
      <GameRunnerScene
        progress={progress}
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <motion.button
            ...
            className="p-4 rounded-xl bg-green-500/90 hover:bg-green-500 font-bold disabled:opacity-60 disabled:cursor-not-allowed shadow-lg"
          >
            {data.safeLabel}
          </motion.button>
          <motion.button
            ...
            disabled={answer !== null}
            className="p-4 rounded-xl bg-red-500/90 hover:bg-red-500 font-bold disabled:opacity-60 disabled:cursor-not-allowed shadow-lg"
          >
            {data.unsafeLabel}
          </motion.button>
        </div>
