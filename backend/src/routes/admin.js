...
router.get('/settings', async (_req, res) => {
  try {
    ...
    res.json({
      encryptionLevel: settings.encryptionLevel || 'Medium',
      adaptiveContentNotes: settings.adaptiveContentNotes || '',
    });
  } catch (e) {
...
router.put('/settings', async (req, res) => {
  try {
    const { encryptionLevel, adaptiveContentNotes } = req.body;
    const updates = {};
    if (encryptionLevel !== undefined) updates.encryptionLevel = String(encryptionLevel);
    if (adaptiveContentNotes !== undefined) updates.adaptiveContentNotes = String(adaptiveContentNotes);
