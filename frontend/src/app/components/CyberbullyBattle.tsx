    ...
    <div className="max-w-3xl mx-auto relative z-10">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <button onClick={() => submit('ignore')} disabled={choice !== null} className="p-3 rounded-xl bg-slate-500/90 hover:bg-slate-500 font-bold capitalize disabled:opacity-60">Ignore</button>
          <button onClick={() => submit('report')} disabled={choice !== null} className="p-3 rounded-xl bg-blue-500/90 hover:bg-blue-500 font-bold capitalize disabled:opacity-60">Report</button>
          <button onClick={() => submit('block')} disabled={choice !== null} className="p-3 rounded-xl bg-red-500/90 hover:bg-red-500 font-bold capitalize disabled:opacity-60">Block</button>
          <button onClick={() => submit('support')} disabled={choice !== null} className="p-3 rounded-xl bg-green-500/90 hover:bg-green-500 font-bold capitalize disabled:opacity-60">Support</button>
        </div>
      </motion.div>
